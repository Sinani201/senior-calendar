window.onload = function() {
	...
	var bdates = [new Date(2015, 2, 3), new Date(2015, 2, 5), new Date(2015, 2, 6), new Date(2015, 2, 10), new Date(2015, 2, 12), new Date(2015, 2, 17), new Date(2015, 2, 19), new Date(2015, 2, 24), new Date(2015, 2, 26), new Date(2015, 2, 27), new Date(2015, 3, 3), new Date(2015, 3, 5), new Date(2015, 3, 10), new Date(2015, 3, 12), new Date(2015, 3, 13), new Date(2015, 3, 17), new Date(2015, 3, 19), new Date(2015, 3, 24), new Date(2015, 3, 26), new Date(2015, 3, 27)];
